...
namespace DataLayer
{
    public class RptCallAverageDL
    {
        public RptCallAverageDL()
        {
            //
        ...
        public StaticData PopulateDropdownOnData(string filteron, string values, string yr, string mvalue, string dvalue)
        {
            ...
            {
                string sql = "select distinct Division from rpt_callaverage where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                ...
                //zsm
                sql = "select distinct ZSMHQ from rpt_callaverage where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                ...
                //rsm
                sql = "select distinct RSMHQ from rpt_callaverage where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct HQ from rpt_callaverage where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                    if (Common.GetString(rdr["HQ"]) != "")
                        itmstaticdata.lsthq.Add(Common.GetString(rdr["HQ"]));
                }
                rdr.Close();

                sql = "select distinct EmpName from rpt_callaverage where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
            ...
            if (filteron != null && filteron != "" && filteron.ToLower() == "division")
            {
                ...
                //zsm
                string sql = "select distinct ZSMHQ from rpt_callaverage where lower(division) in(" + values.ToLower() + ")" + extra;
                SqlCommand cmd = new SqlCommand(sql, Common.conn);
                SqlDataReader rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                //rsm
                sql = "select distinct RSMHQ from rpt_callaverage where lower(division) in(" + values.ToLower() + ")" + extra;
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                //hq
                sql = "select distinct HQ from rpt_callaverage where lower(division) in(" + values.ToLower() + ")" + extra;
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct EmpName from rpt_callaverage where lower(division) in(" + values.ToLower() + ")" + extra;
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
        ...
        public String populateReportFromSP(string mont,int mno)
        {
            ...
            Common.OpenConnection();
            string sql = "delete from rpt_callaverage where monthno=" + mno + " and year='" + curyear.ToString() + "'";
            SqlCommand cmd = new SqlCommand(sql, Common.conn);
            cmd.ExecuteNonQuery();

            using (SqlCommand cmd1 = new SqlCommand("SaveCallAverageReportFromDT"))
            {
            ...
            ret = "Execution completed for Call Average report";
            return ret;
        }
    }
}