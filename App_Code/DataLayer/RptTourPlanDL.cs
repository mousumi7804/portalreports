...
namespace DataLayer
{
    public class RptTourPlanDL
    {
        public RptTourPlanDL()
        {
            //
        ...
        public StaticData PopulateDropdownOnData(string filteron, string values, string yr, string mvalue, string dvalue)
        {
            ...
            {
                string sql = "select distinct Division from rpt_tourplan where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                ...
                //zsm
                sql = "select distinct ZSMHQ from rpt_tourplan where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                ...
                //rsm
                sql = "select distinct RSMHQ from rpt_tourplan where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct Area from rpt_tourplan where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct EmpName from rpt_tourplan where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
            ...
            if (filteron != null && filteron != "" && filteron.ToLower() == "division")
            {
                ...
                //zsm
                string sql = "select distinct ZSMHQ from rpt_tourplan where lower(division) in(" + values.ToLower() + ")" + extra;
                SqlCommand cmd = new SqlCommand(sql, Common.conn);
                SqlDataReader rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                //rsm
                sql = "select distinct RSMHQ from rpt_tourplan where lower(division) in(" + values.ToLower() + ")" + extra;
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct Area from rpt_tourplan where lower(division) in(" + values.ToLower() + ")" + extra;
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct EmpName from rpt_tourplan where lower(division) in(" + values.ToLower() + ")" + extra;
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
        ...
        public DataSet GetTourPlanReportDataDynamic(SearchReportCommon itmsearch, int rows)
        {
            Common.OpenConnection();
            
            String sql = "select * from rpt_tourplan";
            if (rows > 0)
                sql = "select top " + rows + " * from rpt_tourplan";
        ...
        public String populateReportFromSP(string mont,int mno)
        {
            ...
            Common.OpenConnection();
            string sql = "delete from rpt_tourplan where monthno=" + mno + " and year='" + curyear.ToString() + "'";
            SqlCommand cmd = new SqlCommand(sql, Common.conn);
            cmd.ExecuteNonQuery();

            using (SqlCommand cmd1 = new SqlCommand("SaveTourPlanReportFromDT"))
            {
            ...
            ret = "Execution completed for Tour Plan report";
            return ret;
        }
    }
}