...
namespace DataLayer
{
    public class RptSampleDL
    {
        ...
        public StaticData PopulateDropdownOnData(string filteron, string values, string yr, string mvalue, string dvalue)
        {
            ...
            {
                string sql = "select distinct Division from rpt_sample where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                ...
                //zsm
                sql = "select distinct ZSMHQ from rpt_sample where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                ...
                //rsm
                sql = "select distinct RSMHQ from rpt_sample where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct District from rpt_sample where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct EmpName from rpt_sample where lower(month) ='" + values.ToLower() + "'" + " and year='" + yr + "'";
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
            ...
            if (filteron != null && filteron != "" && filteron.ToLower() == "division")
            {
                ...
                //zsm
                string sql = "select distinct ZSMHQ from rpt_sample where lower(division) in(" + values.ToLower() + ")" + extra;
                SqlCommand cmd = new SqlCommand(sql, Common.conn);
                SqlDataReader rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                //rsm
                sql = "select distinct RSMHQ from rpt_sample where lower(division) in(" + values.ToLower() + ")" + extra;
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct District from rpt_sample where lower(division) in(" + values.ToLower() + ")" + extra;
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                ...
                sql = "select distinct EmpName from rpt_sample where lower(division) in(" + values.ToLower() + ")" + extra;
                cmd = new SqlCommand(sql, Common.conn);
                rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
        ...
        public DataSet GetSampleReportDataDynamic(SearchReportCommon itmsearch, int rows)
        {
            ...
            String sql = "select * from rpt_sample";
            if (rows > 0)
                sql = "select top " + rows + " * from rpt_sample";
        ...
        public String populateReportFromSP(string mont,int mno)
        {
            ...
            Common.OpenConnection();
            string sql = "delete from rpt_sample where monthno=" + mno + " and year='" + curyear.ToString() + "'";
            SqlCommand cmd = new SqlCommand(sql, Common.conn);
            cmd.ExecuteNonQuery();

            using (SqlCommand cmd1 = new SqlCommand("SaveSampleReportFromDT"))
            {
            ...
            ret = "Execution completed for Sample report";
            return ret;
        }
    }
}