...
/// <summary>
/// Summary description for RptAgeing
/// </summary>
/// 
namespace model
{
    ...
    public class StaticData
    {
        ...
        public List<String> lstdivision { get; set; }

        public List<String> lstdistrict { get; set; }
        public List<String> lstemployee { get; set; }
        public List<String> lstdesignation { get; set; }

        public List<String> lstzsm { get; set; }
        public List<String> lsthq { get; set; }
    }
}