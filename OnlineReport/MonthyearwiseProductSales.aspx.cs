...
public partial class OnlineReport_MonthyearwiseProductSales : System.Web.UI.Page
{
    ...
    public void ReportBinding()
    {
        ...
        using (SqlConnection conn = new SqlConnection(constr))
        {
            ...
            using (SqlCommand cmd = new SqlCommand("yearwisesaleautomation"))
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    using (DataTable dt = new DataTable())
                    {
                        ...
                        {
                            rpt_Transactionbilltrends.ReportTitle = "Year wise Sale";
                            rpt_Transactionbilltrends.ReportName = "Year wise Sale";
