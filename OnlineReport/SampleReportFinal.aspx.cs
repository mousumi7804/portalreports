...
public partial class OnlineReport_SampleReportFinal : System.Web.UI.Page
{
    string gmonth = "";
    ...
    {
        DataSet ds = (new RptSampleDL()).GetSampleReportDataDynamic(searchdoctorvisit, rows);
        ...
        ds.Tables[0].Columns.Remove("rptsampleID");
        ...
        rpt_sample.ReportTitle = "Sample Report";
        rpt_sample.ReportName = "SampleReport";
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        ...
        StaticData itmstat = (new RptSampleDL()).GetDropdownData(monthsearch, curyear);      //curyear);
    ...
    private void populatedropdowns()
    {
       ...
       // prevmonth = "september";
        ...
        String curyear = DateTime.Now.Year.ToString();
        StaticData itmstat = (new RptSampleDL()).GetDropdownData("'" + prevmonth + "'", lastdayofprevmonth.Year.ToString());      //curyear);
    ...
    protected void btnhiddenforjs_Click(object sender, EventArgs e)
    {
        ...
        StaticData itmstaticdata = (new RptSampleDL()).PopulateDropdownOnData("division", divsearch, yr, monthsearch, "");
