<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="contractual_ins.aspx.cs" Inherits="OnlineReport_TransactionBillData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
     ...
     <div class="row">
            ...
            <div class="col-md-2">
               <%-- <label for="From Date">
                ...
                <asp:TextBox ID="Customercode" autocomplete="off" runat="server" Visible="false"></asp:TextBox>
            </div>
            <div class="col-md-2">
                <label for="From Date">
               ...
               <%-- <asp:DropDownList ID="customertype" runat="server">
                ...
                <asp:ListBox ID="customertype" runat="server" SelectionMode="Multiple" Visible="false"
            >
                    <asp:ListItem>Contructual</asp:ListItem>
                    <asp:ListItem>Institution</asp:ListItem>
                    <asp:ListItem>Retailer</asp:ListItem>
            ...
            <div class="col-md-2">
               <%-- <label for="From Date">
                    Bill No:</label><br />--%>
                <asp:TextBox ID="BillNo" autocomplete="off" runat="server" Visible="false"></asp:TextBox>
            </div>
            <div class="col-md-2">
              <%--  <label for="From Date">
            ...
            DataValueField="STOCKLOCATION" Visible="false"></asp:ListBox>
        ...
        <div class="row">
            ...
            DataValueField="Mpharm_Pd_Name" Visible="false"></asp:ListBox>
            ...
            <div class="col-md-2">
               <%-- <label for="From Date">
                    HQ:</label><br />--%>
                <asp:TextBox ID="HQ" autocomplete="off" runat="server" Visible="false"></asp:TextBox>
            </div>
            <div class="col-md-2">
            <br />
   ...
   <div align="center"> <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1100px">
    </rsweb:ReportViewer>
    </div>
</asp:Content>
