<%@ Page Title="Sales Report" Language="C#" MasterPageFile="~/OnlineReport/OReport.master"
    AutoEventWireup="true" CodeFile="MonthlyReportDemo.aspx.cs" Inherits="OnlineReport_StockReport" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                    ...
                    <div class="col-md-12 table-responsive">
                        <div class="panel panel-default">
                            <div class=" panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 table-responsive">
                                        <asp:GridView ID="GridView1" runat="server"  Height="400px"  CssClass="myGridStyle" ShowFooter="true" DataSourceID="SqlDataSource1">
                                        </asp:GridView>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT * FROM [Mad_totalsale]"></asp:SqlDataSource>
        </ContentTemplate>
        <Triggers>
