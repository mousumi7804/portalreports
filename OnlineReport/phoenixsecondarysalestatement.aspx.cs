...
public partial class OnlineReport_phoenixsecondarysalestatement : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

    }
    private phoenixsecondarysalestatement GetData()
    {
        ...
        using (SqlConnection con = new SqlConnection(conString))
        {
            using (SqlDataAdapter sda = new SqlDataAdapter())
            {
                ...
                cmd.Parameters.AddWithValue("@action", "PHOENIX");
                ...
                using (phoenixsecondarysalestatement dsCustomers = new phoenixsecondarysalestatement())
                {
                    sda.Fill(dsCustomers, "phoenixsecondarysalestatement");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report/phoenixsecondarysalestatement.rdlc");
        phoenixsecondarysalestatement dsCustomers = GetData();
        ReportDataSource datasource = new ReportDataSource("phoenixsecondarysalestatement", dsCustomers.Tables[0]);
