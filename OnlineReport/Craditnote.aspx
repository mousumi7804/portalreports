<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Craditnote.aspx.cs" Inherits="OnlineReport_Craditnote" %>
    ...
    <div class="alert alert-info" role="alert">
     <div class="row">
            ...
            <div class="col-md-2">
                <label for="From Date">
                    HQ:</label><br />
                <asp:TextBox ID="HQ" autocomplete="off" runat="server" 
                    ></asp:TextBox>
            </div>
                 </div>
        <div class="row">
            ...
            <div class="col-md-2">
                <label for="From Date">
                    Return Type:</label><br />
                <%--<asp:DropDownList ID="RTD" runat="server" DataSourceID="craditnote" 
                    DataTextField="ReturnTypeDesc" DataValueField="ReturnTypeDesc">
                </asp:DropDownList>--%>

                 <asp:ListBox ID="RTD" runat="server" SelectionMode="Multiple" 
            DataSourceID="craditnote" DataTextField="ReturnTypeDesc" 
            DataValueField="ReturnTypeDesc"></asp:ListBox>

                <asp:SqlDataSource ID="craditnote" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString_master %>" SelectCommand="select ReturnTypeDesc from (SELECT 
      upper([ReturnTypeDesc]) ReturnTypeDesc
      
  FROM [MendineMaster].[dbo].[tblReturnType_Mas]
  where pkreturntypeid in (1,2,3)
  ) a
  order by ReturnTypeDesc"></asp:SqlDataSource>
            </div>
            <div class="col-md-2">
            <br />
