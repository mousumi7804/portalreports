<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DoctorVisitReportFinal.aspx.cs" Inherits="OnlineReport_AgeingReportFinal" %>
            ...
            <div class="container">
                ...
                <div id="adminsearch" style="visibility: visible;" >
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-md-3">
                            <asp:ListBox ID="src_asm" runat="server" SelectionMode="Multiple" AppendDataBoundItems="false"></asp:ListBox>
                        </div>
                    </div>
                    <div class="row">&nbsp;</div>
                    <div class="row">
                        <div class="col-md-3">
                            <label>MFSO-HQ</label></div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <asp:ListBox ID="src_mfso" runat="server" SelectionMode="Multiple" AppendDataBoundItems="false"></asp:ListBox>
                        </div>
                        <div class="col-md-3">
                            <asp:ListBox ID="src_district" runat="server" SelectionMode="Multiple" AppendDataBoundItems="false"></asp:ListBox>
                        </div>
                        <div class="col-md-3">
                            <asp:ListBox ID="src_designation" runat="server" SelectionMode="Multiple" AppendDataBoundItems="false"></asp:ListBox>
                        </div>
                        <div class="col-md-3">
            ...
            <script type="text/javascript">
                function pageLoad(sender, args) {
                    $(document).ready(function () {
                        ...
                        $('[id*=src_designation]').multiselect({
                            includeSelectAllOption: true,
                            maxHeight: 400,
                            enableFiltering: true,
                            enableCaseInsensitiveFiltering: true
                ...
                function DropdownPopulateonRSM() {
