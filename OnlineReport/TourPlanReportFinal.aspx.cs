...
public partial class OnlineReport_TourPlanReportFinal : System.Web.UI.Page
{
    string gmonth = "";
    ...
    {
        DataSet ds = (new RptTourPlanDL()).GetTourPlanReportDataDynamic(searchdoctorvisit, rows);
        ...
        ds.Tables[0].Columns.Remove("rpttourplanID");
        ...
        rpt_tourplan.ReportTitle = "Tour Plan Report";
        rpt_tourplan.ReportName = "TourPlanReport";
        rpt_tourplan.DataBind(ds.Tables[0].Copy());
        rpt_tourplan.Visible = true;
    ...
    private void populatedropdowns()
    {
        ...
        String curyear = DateTime.Now.Year.ToString();
        StaticData itmstat = (new RptTourPlanDL()).GetDropdownData("'" + prevmonth + "'", lastdayofprevmonth.Year.ToString());      //curyear);
    ...
    protected void btnhiddenforjs_Click(object sender, EventArgs e)
    {
        ...
        StaticData itmstaticdata = (new RptTourPlanDL()).PopulateDropdownOnData("division", divsearch, yr, monthsearch, "");
