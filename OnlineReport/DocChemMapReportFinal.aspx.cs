...
public partial class OnlineReport_AgeingReportFinal : System.Web.UI.Page
{
    ...
    {
        DataSet ds = (new RptDocChemMapDL()).GetDocChemMapReportDataDynamic(searchdoctorvisit, rows);
        ...
        ds.Tables[0].Columns.Remove("rptdoctchemmapID");
        ...
        rpt_docchemmap.ReportTitle = "Doctor Chemist Mapping Report";
        rpt_docchemmap.ReportName = "DoctorChemistMappingReport";
    ...
    private void populatedropdowns()
    {
        ...
        //  src_month4m.SelectedValue = "september".ToUpper();        //prevmonth;
        ...
        String curyear = DateTime.Now.Year.ToString();
        StaticData itmstat = (new RptDocChemMapDL()).GetDropdownData("'" + prevmonth + "'", curyear);
        src_area.DataSource = itmstat.lstarea;
        src_area.DataBind();
    ...
    protected void btnhiddenforjs_Click(object sender, EventArgs e)
    {
        ...
        StaticData itmstaticdata = (new RptDocChemMapDL()).PopulateDropdownOnData("division", divsearch, yr, monthsearch, "");
