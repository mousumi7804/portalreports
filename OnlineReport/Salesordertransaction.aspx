<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Salesordertransaction.aspx.cs" Inherits="OnlineReport_Salesordertransaction" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="row">
                        ...
                        <div class="alert alert-info" role="alert">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <asp:ListBox ID="OrderStatus" runat="server" SelectionMode="Multiple">
                    ...
                    order by STOCKLOCATION  "></asp:SqlDataSource>
                                </div>
                                <div class="col-md-3">
                                    <label for="From Date">
                    ...
                    DataTextField="Mpharm_Pd_Name" DataValueField="Mpharm_Pd_Name">
                                    ...
                                    <asp:ListBox ID="PPS" runat="server" SelectionMode="Multiple" DataSourceID="mendinemaster"
                                        DataTextField="Mpharm_Pd_Name" DataValueField="Mpharm_Pd_Name"></asp:ListBox>
                    ...
                    FROM [ProductTransform] 
                                ...
                                <div class="col-md-2">
                                    ...
                                    <asp:Button ID="Button1" Text="Show Report" runat="server" CssClass="btn btn-primary"
                                        ValidationGroup="req" OnClick="Button1_Click" />
                                </div>
                                <div class="col-md-5">
